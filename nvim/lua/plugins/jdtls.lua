        ...
        jdtls = function(_, opts)
          vim.api.nvim_create_autocmd("FileType", {
            ...
            callback = function()
              ...
              local workspace_dir = "/home/achim/.workspace/" .. project_name -- See `:help vim.lsp.start_client` for an overview of the supported `config` options.
              local config = {
                ...
                cmd = {
                  ...
                  "-jar",
                  vim.fn.glob(
                    "/home/achim/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_*.jar"
                  ),
                  -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
                  ...
                  "-configuration",
                  "/home/achim/.local/share/nvim/mason/packages/jdtls/config_linux",
                  -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
